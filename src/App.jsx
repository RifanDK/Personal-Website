...
const Contact = ({ data, isActive }) => (
  ...
  >
    <div className="max-w-4xl w-full text-center">
      ...
      <div className="mb-8 bg-gray-900 rounded-lg p-6 border border-purple-500/20 inline-block">
        <div className="flex items-center gap-3 justify-center">
          <Mail size={24} className="text-purple-400" />
          <span className="text-xl font-semibold text-white">{data.email}</span>
        </div>
      </div>
      <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
        <a
          href="https://instagram.com/rif_arrays"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-4 rounded-lg hover:scale-105 transition-transform duration-300 w-full sm:w-auto justify-center"
        >
